...
namespace Client.Services
{
    public class ProdutosServices
    {
        ...
        public void EnviarBusca(Produtos produtos)
        {
        ...
        public void EnviarBuscaNome(Produtos produtos)
        {
            //recebe os dados para enviar para a API cria a viewModel que será enviada;
            var viewModel = new
            {
            ...
            {
                //envia os dados para a API, convertendo em uma cadeia de string
                response = httpClient.PostAsync("https://localhost:44363/produtos/enviarBuscaNome", new StringContent(json, Encoding.UTF8, "application/json")).Result;
                response.EnsureSuccessStatusCode();
                //faz a request, envia os dados e recebe a resposta da API.
                var resultado = response.Content.ReadAsStringAsync().Result;
            }
